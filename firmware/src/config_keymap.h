...
#define SCANCODE_MOUSEWHEELUP 0xBA
#define SCANCODE_MOUSEWHEELDOWN 0xBB
#define SCANCODE_MOUSEWHEELLEFT 0xBC
#define SCANCODE_MOUSEWHEELRIGHT 0xFA
...
#define SCANCODE_PASSWORD1 0xC4
#define SCANCODE_PASSWORD2 0xC5
#define SCANCODE_PASSWORD3 0xC6
#define SCANCODE_PASSWORD4 0xC7

...
scancodes = {
    ...
    "SCANCODE_BRIGHT_INC": ("Bright\nUp", 0x9B, "Brt+"),
    "SCANCODE_BRIGHT_DEC": ("Bright\nDown", 0x9C, "Brt-"),
    "SCANCODE_MUTE": ("Mute", 0x9D, "Mute"),
    "SCANCODE_BASS_BOOST": ("Bass\nBoost", 0x9E, "Bass"),
    "SCANCODE_VOL_INC": ("Vol\nUp", 0x9F, "Vol+"),
    "SCANCODE_VOL_DEC": ("Vol\nDown", 0xA0, "Vol-"),
    "SCANCODE_BASS_INC": ("Bass\nUp", 0xA1, "Bas+"),
    "SCANCODE_BASS_DEC": ("Bass\nDown", 0xA2, "Bas-"),
    "SCANCODE_TREB_INC": ("Treb\nUp", 0xA3, "Trb+"),
    "SCANCODE_TREB_DEC": ("Treb\nDown", 0xA4, "Trb-"),
    "SCANCODE_MEDIA_SEL": ("Media\nSelect", 0xA5, "MSel"),
    "SCANCODE_MAIL": ("Mail", 0xA6, "Mail"),
    "SCANCODE_CALC": ("Calc", 0xA7, "Calc"),
    "SCANCODE_MYCOMP": ("My\nComp", 0xA8, "Comp"),
    "SCANCODE_SEARCH": ("Search", 0xA9, "Srch"),
    ...
    "SCANCODE_MOUSE4": ("Mouse\nBtn 4", 0xB4, "MB4"),
    "SCANCODE_MOUSE5": ("Mouse\nBtn 5", 0xB5, "MB5"),
    "SCANCODE_MOUSEXR": ("Mouse\nRight", 0xB6, "Mrt"),
    "SCANCODE_MOUSEXL": ("Mouse\nLeft", 0xB7, "Mlf"),
    "SCANCODE_MOUSEYU": ("Mouse\nUp", 0xB8, "Mup"),
    "SCANCODE_MOUSEYD": ("Mouse\nDown", 0xB9, "Mdn"),
    "SCANCODE_MOUSEWHEELUP": ("Wheel\nUp", 0xBA, "WhUp"),
    "SCANCODE_MOUSEWHEELDOWN": ("Wheel\nDown", 0xBB, "WhDn"),
    "SCANCODE_MOUSEWHEELLEFT": ("Wheel\nLeft", 0xBC, "WhLt"),
    "SCANCODE_MOUSEWHEELRIGHT": ("Wheel\nRight", 0xFA, "WhRt"),    
    ...
    "SCANCODE_PASSWORD1": ("PW1", 0xC4, "PW1"),
    "SCANCODE_PASSWORD2": ("PW2", 0xC5, "PW2"),
    "SCANCODE_PASSWORD3": ("PW3", 0xC6, "PW3"),
    "SCANCODE_PASSWORD4": ("PW4", 0xC7, "PW4"),
    "SCANCODE_KEYLOCK": ("KB\nLock", 0xC8, "KbLk"),

...
class Picker(object):
    ...
    def createwindow(self):
        ...
        Selector(rowframe, self.main, 4, "SCANCODE_MOUSE4")
        Selector(rowframe, self.main, 4, "SCANCODE_MOUSE5")
        Spacer(rowframe, 2, 4)
        ...
        Selector(rowframe, self.main, 4, "SCANCODE_BRIGHT_INC")
        Selector(rowframe, self.main, 4, "SCANCODE_BRIGHT_DEC")
        ...
        Selector(rowframe, self.main, 4, "SCANCODE_BASS_INC")
        Selector(rowframe, self.main, 4, "SCANCODE_BASS_DEC")
        Selector(rowframe, self.main, 4, "SCANCODE_TREB_INC")
        Selector(rowframe, self.main, 4, "SCANCODE_TREB_DEC")
        Spacer(rowframe, 4, 4)
        ...
        Selector(rowframe, self.main, 4, "SCANCODE_WWWSTOP")
        Selector(rowframe, self.main, 4, "SCANCODE_REFRESH")
        Selector(rowframe, self.main, 4, "SCANCODE_FAVES")
        Spacer(rowframe, 4, 4)
